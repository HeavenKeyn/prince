...
public class CommandFactory 
{
   ...
   */
  public static Command getCommand(BufferedReader in,
								   BufferedWriter out,
    ...
    throws IOException
  {
	...
	switch (command) 
	  ...
	  case MsgProtocol.REGISTER: //107
		  return new RegisterCommand(in, out, serverConn);
	  case MsgProtocol.UPDATE: //108
		  return new UpdateCommand(in, out, serverConn);
	    /*
